...
if _IS_CLOUD:
    st.info("🔄 **Data updates automatically every Monday at 7:30 AM IST / 10:00 AM SGT** — no action needed. The latest Nium Playbook data is always pulled fresh and reflected here within the hour.", icon="✅")
